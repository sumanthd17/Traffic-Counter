...
/**
 This method gets the Float32 input tensor at a specified index.
 */
...
/**
 This method gets the Int input tensor at a specified index.
 */
- (int *)intInputTensorAtIndex:(int)index;

/**
 This method reshapes the tensor.
 */
